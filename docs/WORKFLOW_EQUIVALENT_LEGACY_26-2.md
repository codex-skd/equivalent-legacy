...
> Este archivo pertenece al proyecto **Equivalent Legacy**. Cambios aquí solo afectan a este proyecto.
...
| Última versión publicada | `1.5.3` (CurseForge file ID 8687979) |
| Estado | ✅ Release estable 1.5.3 |
...
|---|---|---|
| **snake_case** | `mod_id`, assets/, packages Java | `equivalent_legacy` |
| **PascalCase** | Clases Java principales | `EquivalentLegacy` |
| **camelCase** | Variables, métodos, config keys | `equivalent_legacyConfig` |
| **Title Case** | Display name (README, CHANGELOG, docs, CurseForge) | `Equivalent Legacy` |
