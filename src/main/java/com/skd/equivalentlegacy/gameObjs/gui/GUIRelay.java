...
public class GUIRelay<CONTAINER extends RelayMK1Container> extends PEContainerScreen<CONTAINER> {
	...
	protected void peExtractLabels(@NotNull GuiGraphics graphics, int mouseX, int mouseY) {
		graphics.drawString(font, EMCHelper.formatEmc(menu.emc.get()), emcX, emcY, PEGuiGraphics.LABEL_COLOR, false);
	}
	...
	public static class GUIRelayMK1 extends GUIRelay<RelayMK1Container> {
		...
		private static final ResourceLocation MK1_TEXTURE = ELCore.rl("textures/gui/relay1.png");
	...
	public static class GUIRelayMK2 extends GUIRelay<RelayMK2Container> {
		...
		private static final ResourceLocation MK2_TEXTURE = ELCore.rl("textures/gui/relay2.png");
	...
	public static class GUIRelayMK3 extends GUIRelay<RelayMK3Container> {
		...
		private static final ResourceLocation MK3_TEXTURE = ELCore.rl("textures/gui/relay3.png");
