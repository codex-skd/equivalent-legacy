...
public class PEArmorMaterials {
	...
	public static final PEDeferredRegister<ArmorMaterial> ARMOR_MATERIALS = new PEDeferredRegister<>(Registries.ARMOR_MATERIAL, ELCore.MODID);
	...
	public static final PEDeferredHolder<ArmorMaterial, ArmorMaterial> DARK_MATTER = ARMOR_MATERIALS.register("dark_matter", rl -> new ArmorMaterial(
			DIAMOND_RESISTANCES, 18, SoundEvents.ARMOR_EQUIP_NETHERITE, () -> Ingredient.EMPTY, List.of(new ArmorMaterial.Layer(rl)), 2, 0.1F
	));
	public static final PEDeferredHolder<ArmorMaterial, ArmorMaterial> RED_MATTER = ARMOR_MATERIALS.register("red_matter", rl -> new ArmorMaterial(
			DIAMOND_RESISTANCES, 22, SoundEvents.ARMOR_EQUIP_NETHERITE, () -> Ingredient.EMPTY, List.of(new ArmorMaterial.Layer(rl)), 2, 0.2F
	));
	public static final PEDeferredHolder<ArmorMaterial, ArmorMaterial> GEM_ARMOR = ARMOR_MATERIALS.register("gem_armor", rl -> new ArmorMaterial(
			DIAMOND_RESISTANCES, 24, SoundEvents.ARMOR_EQUIP_NETHERITE, () -> Ingredient.EMPTY, List.of(new ArmorMaterial.Layer(rl)), 2, 0.25F
	));
}
