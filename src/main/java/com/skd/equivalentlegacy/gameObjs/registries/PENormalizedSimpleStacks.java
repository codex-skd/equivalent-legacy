...
public class PENormalizedSimpleStacks {
	...
	public static final DeferredCodecRegister<NormalizedSimpleStack> NSS_SERIALIZERS = new DeferredCodecRegister<>(EquivalentLegacyRegistries.NSS_SERIALIZER_NAME, PECore.MODID);
