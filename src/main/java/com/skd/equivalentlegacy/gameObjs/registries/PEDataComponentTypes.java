...
import com.skd.equivalentlegacy.gameObjs.items.MercurialEye.MercurialEyeMode;
...
import com.skd.equivalentlegacy.gameObjs.items.rings.SWRG.SWRGMode;
import com.skd.equivalentlegacy.gameObjs.items.rings.TimeWatch.TimeWatchMode;
...
import com.skd.equivalentlegacy.gameObjs.registration.impl.DataComponentTypeDeferredRegister;
...
public class PEDataComponentTypes {
	...
	/**
	 * @see com.skd.equivalentlegacy.api.PEDataComponents#CHARGE
	 */
