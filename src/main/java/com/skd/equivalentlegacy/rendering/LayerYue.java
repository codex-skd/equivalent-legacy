...
public class LayerYue extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
	...
	private static final ResourceLocation HEART_LOC = ELCore.rl("textures/models/heartcircle.png");
	private static final ResourceLocation YUE_LOC = ELCore.rl("textures/models/yuecircle.png");
