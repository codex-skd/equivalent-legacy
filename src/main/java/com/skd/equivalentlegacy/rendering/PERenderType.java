...
public class PERenderType extends RenderType {
	...
	public static final Function<ResourceLocation, RenderType> SPRITE_RENDERER = Util.memoize(resourceLocation -> {
		...
		return create("equivalent_legacy_sprite_renderer", DefaultVertexFormat.POSITION_TEX, Mode.QUADS, 256, true, false, state);
	});
	...
	public static final Function<ResourceLocation, RenderType> YEU_RENDERER = Util.memoize(resourceLocation -> {
		RenderType.CompositeState state = RenderType.CompositeState.builder()
				...
				.createCompositeState(true);
		return create("equivalent_legacy_yeu_renderer", DefaultVertexFormat.POSITION_TEX_COLOR, Mode.QUADS, 256, true, false, state);
	});

	public static final RenderType TRANSMUTATION_OVERLAY = create("equivalent_legacy_transmutation_overlay", DefaultVertexFormat.POSITION_COLOR, Mode.QUADS, 256,
