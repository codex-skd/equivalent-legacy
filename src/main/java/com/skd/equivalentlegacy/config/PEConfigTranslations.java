...
public enum PEConfigTranslations implements IConfigTranslation {
	...
	CLIENT_TOOLTIPS("client.tooltips", "Tooltip Settings", "Settings for configuring Tooltips provided by EquivalentLegacy.", true),
	...
	CLIENT_TOOLTIPS_STATS("client.tooltips.stats", "Stat Tooltips", "Show stats as tooltips for various EquivalentLegacy blocks."),
	...
	COMMON_CRAFTING("common.crafting", "Crafting Settings", "Settings for configuring crafting requirements of specific EquivalentLegacy recipes.", true),
	...
	SERVER_COOLDOWN("server.cooldown", "Cooldown Settings",
			"Settings for configuring the Cooldown (in ticks) for various features in EquivalentLegacy. "
	...
	SERVER_DIFFICULTY("server.difficulty", "Difficulty Settings", "Settings for configuring Difficulty options provided by EquivalentLegacy.", true),
	...
	SERVER_EFFECTS("server.effects", "Effect Settings", "Settings for configuring Effect options provided by EquivalentLegacy.", true),
	...
	SERVER_ITEMS("server.items", "Item Settings", "Settings for configuring Item options provided by EquivalentLegacy.", true),
	SERVER_ITEMS_PICKAXE_AOE_VEIN_MINING("server.items.pickaxe_aoe_vein_mining", "Pickaxe AOE Vein Mining",
			...
			+ "like it did in EquivalentLegacy before version 1.4.4."),
	...
	SERVER_MISC("server.misc", "Misc Settings", "Settings for configuring misc options provided by EquivalentLegacy.", true),
	...
	MAPPING_DUMP_TO_FILE("mapping.dump_to_file", "Dump Everything To File",
			"Want to take a look at the internals of EMC Calculation? Enable this to write all the conversions and setValue-Commands to config/EquivalentLegacy/mapping_dump.json"),
	MAPPING_PREGENERATED("mapping.pregenerated", "Pregenerate EMC",
			"When the next EMC mapping occurs write the results to config/EquivalentLegacy/pregenerated_emc.json and only ever run the mapping again when that file "
	...
	MAPPING_LOG_EXPLOITS("mapping.log_exploits", "Log Known EMC Exploits",
			...
			+ "that the algorithm did not overwrite. Exploits that derive from conversions that are unknown to EquivalentLegacy will not be found."),
