package com.skd.equivalentlegacy.api.components;
...
public interface IComponentProcessorHelper {
	...
	IComponentProcessorHelper INSTANCE = ServiceLoader.load(IComponentProcessorHelper.class).findFirst()
			.orElseThrow(() -> new IllegalStateException("No valid ServiceImpl for IComponentProcessorHelper found, EquivalentLegacy may be absent, damaged, or outdated"));
