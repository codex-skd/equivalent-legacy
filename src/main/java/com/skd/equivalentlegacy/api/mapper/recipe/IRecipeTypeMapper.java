package com.skd.equivalentlegacy.api.mapper.recipe;

import com.skd.equivalentlegacy.api.config.IConfigurableElement;
...
public interface IRecipeTypeMapper extends IConfigurableElement {
	 ...
	 * @implNote Due to how the fakeGroupManager works, {@link com.skd.equivalentlegacy.api.nss.NSSFake} implementations should only be created in this method with
