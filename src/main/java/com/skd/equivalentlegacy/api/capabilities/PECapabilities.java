package com.skd.equivalentlegacy.api.capabilities;

import com.skd.equivalentlegacy.api.EquivalentLegacyAPI;
import com.skd.equivalentlegacy.api.capabilities.block_entity.IEmcStorage;
...
public class PECapabilities {
	...
	private static ResourceLocation rl(String path) {
		return ResourceLocation.fromNamespaceAndPath(EquivalentLegacyAPI.EQUIVALENT_LEGACY_MODID, path);
	}
