package com.skd.equivalentlegacy.api.capabilities.block_entity;
 ...
 * <p>
 * The contract of this interface is only the above statement However, EquivalentLegacy implements an "active-push" system, where providers automatically send EMC to acceptors.
...
public interface IEmcStorage {
	 ...
	 *
	 * @implNote If two neighboring {@link IEmcStorage}s are both relays, EquivalentLegacy's blocks (relays) will not try send Emc to each other. This is to prevent thrashing.
	 */
