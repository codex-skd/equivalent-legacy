package com.skd.equivalentlegacy.api.codec;
...
public interface IPECodecHelper {
	...
	/**
	 * Helper for dealing with {@link Codec Codecs} related to EquivalentLegacy.
	 */
	IPECodecHelper INSTANCE = ServiceLoader.load(IPECodecHelper.class).findFirst()
			.orElseThrow(() -> new IllegalStateException("No valid ServiceImpl for IPECodecHelper found, EquivalentLegacy may be absent, damaged, or outdated"));
