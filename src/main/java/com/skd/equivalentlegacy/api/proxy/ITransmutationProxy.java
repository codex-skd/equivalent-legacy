package com.skd.equivalentlegacy.api.proxy;
...
public interface ITransmutationProxy {
	...
	ITransmutationProxy INSTANCE = ServiceLoader.load(ITransmutationProxy.class).findFirst()
			.orElseThrow(() -> new IllegalStateException("No valid ServiceImpl for ITransmutationProxy found, EquivalentLegacy may be absent, damaged, or outdated"));
