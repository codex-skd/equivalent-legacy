package com.skd.equivalentlegacy.emc.arithmetic;
...
public class FullBigFractionArithmetic implements IValueArithmetic<BigFraction> {
	...
	private static final BigInteger FREE_BIG_INT_VALUE = BigInteger.valueOf(EquivalentLegacyAPI.FREE_ARITHMETIC_VALUE);
