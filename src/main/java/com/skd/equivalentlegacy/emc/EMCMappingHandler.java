...
import com.skd.equivalentlegacy.api.event.EMCRemapEvent;
...
import com.skd.equivalentlegacy.api.mapper.collector.IExtendedMappingCollector;
...
import com.skd.equivalentlegacy.emc.arithmetic.HiddenBigFractionArithmetic;
import com.skd.equivalentlegacy.emc.collector.DumpToFileCollector;
import com.skd.equivalentlegacy.emc.collector.LongToBigFractionCollector;
import com.skd.equivalentlegacy.emc.components.DataComponentManager;
import com.skd.equivalentlegacy.emc.generator.BigFractionToLongGenerator;
import com.skd.equivalentlegacy.emc.mappers.TagMapper;
import com.skd.equivalentlegacy.emc.pregenerated.PregeneratedEMC;
...
import com.skd.equivalentlegacy.utils.AnnotationHelper;
...
public final class EMCMappingHandler {
	...
	public static void map(ReloadableServerResources serverResources, RegistryAccess registryAccess, ResourceManager resourceManager) {
		...
		if (MappingConfig.dumpToFile()) {
			mappingCollector = new DumpToFileCollector<>(EquivalentLegacyConfig.CONFIG_DIR.resolve("mapping_dump.json"), mappingCollector);
		}

		boolean usePregenerated = MappingConfig.usePregenerated();
		Path pregeneratedEmcFile = EquivalentLegacyConfig.CONFIG_DIR.resolve("pregenerated_emc.json");
