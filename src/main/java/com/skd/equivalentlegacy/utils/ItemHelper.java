...
public final class ItemHelper {
	...
	/**
	 * Gets an InteractionResultHolder based on a type
	 */
	public static InteractionResultHolder<ItemStack> actionResultHolderFromType(InteractionResult type, ItemStack stack) {
		if (type.consumesAction()) {
			return InteractionResultHolder.success(stack);
		}
		if (type == InteractionResult.FAIL) {
