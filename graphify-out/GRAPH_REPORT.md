...
## Corpus Check
- 523 files · ~31,486 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1158 nodes · 1148 edges · 436 communities (63 shown, 373 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 58 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fe07c5bf`
...
2. `Changelog — Equivalent Legacy` - 31 edges
...
- `EquivalentLegacyBlockEntities` --references--> `InterdictionTorchBlockEntity`  [EXTRACTED]
  src/main/java/com/skd/equivalentlegacy/block/entity/EquivalentLegacyBlockEntities.java → src/main/java/com/skd/equivalentlegacy/block/entity/InterdictionTorchBlockEntity.java

## Import Cycles
- None detected.

## Communities (436 total, 373 thin omitted)

### Community 1 - "Mod Configuration"
Cohesion: 0.06
Nodes (7): CollectorBlockEntity, CondenserBlockEntity, EMCNetwork, NetworkEvents, CollectorMenu, ServerStartingEvent, ServerStoppingEvent

### Community 2 - "Client Setup"
Cohesion: 0.06
Nodes (11): AbstractContainerScreen, BagScreen, ChestScreen, CollectorScreen, CondenserScreen, MachineScreen, RelayScreen, StorageScreen (+3 more)

### Community 3 - "Gradle Build Script"
Cohesion: 0.12
Nodes (5): ChargableItem, HammerItem, MatterPickaxeItem, MatterSwordItem, ToolAoe
...
Cohesion: 0.08
Nodes (21): CollectorTier, MK1, MK2, MK3, CondenserTier, MK1, MK2, MachineTiers (+13 more)
...
Cohesion: 0.07
Nodes (27): Blocks, CurioItem, Type, BLACK_HOLE_BAND, BODY_STONE, EVERTIDE_AMULET, GEM_OF_ETERNAL_DENSITY, HARVEST_GODDESS_BAND (+19 more)

### Community 15 - "Changelog — Equivalent Legacy"
Cohesion: 0.06
Nodes (31): 0.0.0-beta.1, 0.0.0-beta.10, 0.0.0-beta.11, 0.0.0-beta.12, 0.0.0-beta.13, 0.0.0-beta.14, 0.0.0-beta.15, 0.0.0-beta.16 (+23 more)
...
### Community 23 - "NSSTag"
Cohesion: 0.15
Nodes (6): AeternalisFuel, DarkMatter, RedMatter, Tome, TransmutationTablet, Item

### Community 27 - "MappingConfig"
Cohesion: 0.07
Nodes (4): AlchemicalChestBlockEntity, BaseMachineBlockEntity, RelayBlockEntity, RelayMenu
...
Cohesion: 0.13
Nodes (6): CustomPacketPayload, KnowledgeDataPayload, KnowledgeSyncChangePayload, KnowledgeSyncEmcPayload, KnowledgeSyncPayload, TransmuteRequestPayload
...
Cohesion: 0.09
Nodes (8): Block, BlockEntity, EntityBlock, BaseMachineBlock, InterdictionTorchBlockEntity, InterdictionTorchBlock, MatterFurnaceBlock, TransmutationTableBlock
...
## Knowledge Gaps
- **102 isolated node(s):** `MK1`, `MK2`, `MK3`, `MK1`, `MK2` (+97 more)
...
- **Why does `NSSItem` connect `NSSItem` to `Client Setup`, `PhilosophersStone`, `Server Start`, `Mod Notes`, `Common Setup`, `.syncKnowledgeDataIfChanged`, `TransmutationContainer`, `NSSTag`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `NormalizedSimpleStack` connect `Event Bus` to `NSSItem`, `Mod Notes`, `TransmutationContainer`?**
