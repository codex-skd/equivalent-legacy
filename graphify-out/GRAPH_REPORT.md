...
## Corpus Check
- 517 files · ~30,731 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1149 nodes · 2041 edges · 93 communities (88 shown, 5 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 58 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `640ca9e8`
...
4. `Changelog — Equivalent Legacy` - 27 edges
...
Cohesion: 0.07
Nodes (27): 0.0.0-beta.1, 0.0.0-beta.10, 0.0.0-beta.11, 0.0.0-beta.12, 0.0.0-beta.13, 0.0.0-beta.14, 0.0.0-beta.15, 0.0.0-beta.16 (+19 more)
...
Cohesion: 0.06
Nodes (27): SavedData, SavedDataType, ServerStartingEvent, ServerStoppingEvent, CondenserBlockEntity, BlockEntityTicker, BlockPos, BlockState (+19 more)

### Community 44 - "CollectorBlockEntity"
Cohesion: 0.10
Nodes (15): CollectorBlockEntity, BlockEntityTicker, BlockPos, BlockState, Component, Level, MenuProvider, Override (+7 more)
...
Cohesion: 0.33
Nodes (6): InteractionHand, InteractionResult, Level, Override, Player, PhilosophersStone
...
### Community 74 - "EMCHelper"
Cohesion: 0.18
Nodes (3): EMCHelper, Logger, ItemStack
...
Cohesion: 0.12
Nodes (17): ArmorMaterial, EquipmentAsset, Holder, ICustomIngredient, FullKleinStarIngredient, IngredientType, Item, ItemStack (+9 more)
...
### Community 89 - "EquivalentLegacyDataComponents.java"
Cohesion: 0.60
Nodes (3): DataComponentType, EquivalentLegacyDataComponents, DeferredRegister

## Knowledge Gaps
- **95 isolated node(s):** `MK1`, `MK2`, `MK3`, `MK1`, `MK2` (+90 more)
...
- **Why does `NSSItem` connect `PlayerEvents` to `AbstractNSSTag`, `Server Start`, `PhilosophersStone.java`, `Common Setup`, `CondenserBlockEntity`, `.syncKnowledgeDataIfChanged`, `TransmutationContainer`, `PlayerKnowledge`, `CurioEvents.java`, `CurioItem`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `NormalizedSimpleStack` connect `NormalizedSimpleStack` to `FixedValues`, `Event Bus`, `Server Start`, `PlayerEvents`, `EMCHelper`, `.syncKnowledgeDataIfChanged`, `NSSTag`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `EquivalentLegacyItems` connect `EquivalentLegacyItems` to `KnowledgeSyncChangePayload.java`, `PhilosophersStone.java`, `TransmutationTablet.java`, `MatterMaterials`, `LongArithmetic`, `NSSTag`, `.use`, `CurioItem`, `KnowledgeSyncChangePayload.java`, `AlchemicalBag.java`?**
